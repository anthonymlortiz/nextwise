...
if [ "$MODE" = "prod" ]; then
  ...
  SUITES=(${SUITES_OVERRIDE:-tests/migration.mjs tests/engine.mjs tests/google.mjs tests/dual.mjs tests/syncui.mjs tests/projects.mjs tests/chat.mjs tests/voice.mjs tests/dates.mjs tests/links.mjs tests/theme.mjs tests/fields.mjs tests/session.mjs tests/backup.mjs tests/resurrect.mjs})
fi
